...
url <- parse_url("https://gisservicemt.gov/arcgis/rest/services")
url$path <- paste(url$path, "MSDI_Framework/LandCover/MapServer/2/query", sep = "/")
url$query <- list(
...
url <- "https://gisservicemt.gov/arcgis/rest/services/MSDI_Framework/WetlandsRiparian/MapServer/0"
params <- list(
  where = "1=1",
  outFields = "*",
  f = "geojson"
...
data <- st_read(content(response, "text"))
print(data)
