...
path <- file.path("data/MyProject1/MyProject1.gdb")
...
russian_olive_df <- sf::st_read(dsn = path, layer = "Model_Data")
...
russian_olive_df <- russian_olive_df %>%
  select(PA, X, Y, REAP, FROST_FREE_DAYS, ANNUAL_PRECIP, SUMMER_AVG_MAXTEMP, WINTER_AVG_MINTEMP, SOIL_PH, SOIL_BULK_DENSITY, LEVEL1, LEVEL2, NEAR_WATER_150m)
